...
-   📂 **Open-sourced Training Datasets**: We introduce and will release the first large-scale datasets for training diagnostic world models (118k EHRs) and RL-based agents (16k interactive trajectories), which will be made publicly available on PhysioNet upon approval. Researchers with valid [CITI certification](https://physionet.org/content/mimiciv/view-required-training/3.1/#1) may also contact the authors directly for immediate access.
